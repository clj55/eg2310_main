...
def exploration(data,width,height,resolution,column,row,originX,originY):
        ...
        data = frontierB(data) #Find Frontiers
        data,groups = assign_groups(data) #Group Frontiers
    ...
    def exp(self):
        ...
        while True: #Wait until sensor data arrives.
            ...
            if self.kesif == True:
                ...
                self.t = threading.Timer(t,self.target_callback) #It activates the reconnaissance function shortly before the target.
                self.t.start()
