...
from Move import pick_direction, find_opening_V3, find_next_point
    ...
    def integration(self):
        ...
        if self.laser_range.size != 0:
            ...
            if self.has_target == False or len(lri[0]) >0: #obstacle detected
                ...
                self.find_target()
                path_angle = math.degrees(pick_direction(self.target[0], self.target[1], self.curr_x, self.curr_y, self.yaw))
                print(path_angle)
